...
En lugar de especular con el gráfico, vamos a intentar cuantificar la correlación. La autocorrelación espacial mide cómo influye la distancia en una variable concreta, en este caso la frecuencia de delitos en un distrito.
Según la primera ley geográfica de Tobler, cabe esperar que la mayoría de los fenómenos geográficos presenten algún tipo de autocorrelación espacial. Esto suele ocurrir en los datos con factores humanos, ya que las personas de características similares tienden a residir en barrios similares debido a una serie de razones, como el precio de la vivienda, la proximidad a los lugares de trabajo y factores culturales.
La autocorrelación espacial puede representarse de dos maneras: Globalmente o Localmente. El modelo global crea una medida única que representa todo el conjunto de datos, mientras que los modelos locales nos permiten explorar la agrupación espacial en toda la zona de LA.
En primer lugar, tenemos que asignar vecindades a cada uno de los distritos. Existen dos métodos para hacerlo: Rook o Queen. Podemos trazar los vínculos entre los distritos vecinos para visualizar su distribución en el espacio.
...
neighbours <- poly2nb(districts, queen = T)
neighbours
